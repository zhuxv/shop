...
@section('scriptsAfterJs')
    <script>
        ...
        $(document).ready(function () {
            let searchOrder = $('.search-form select[name=order]');

            $('.search-form input[name=search]').val(filters.search);
            searchOrder.val(filters.order);
