    ...
    <script>
        $(document).ready(function(){
            ...
            $('.btn-remove').click(function(){
                // $(this)可以获取当前点击的 移除 按钮的jquery对象
                // closest() 方法可以获取到匹配选择器的第一个祖先元素, 在这里就是当前点击的移除 按钮之上的 <tr>标签
                // data('id') 方法可以获取到我们之前设置的 data-id属性的值, 也就是对应的SKU id
            ...
            $('#select-all').change(function(){
                ...
                // 对于已经下架的商品我们不希望对应的勾选框会被选中, 因此我们要加上 :not([disabled]) 这个条件
