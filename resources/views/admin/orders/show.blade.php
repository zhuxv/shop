                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if($order->refund_status === \App\Models\Order::REFUND_STATUS_APPLIED)
                                ...
                                <button class="btn btn-sm btn-danger" id="btn-refund-disagree">拒绝</button>
                            @endif
                        </td>
                    </tr>
                @endif
...
<script>
    $(document).ready(function(){
        ...
        $('#btn-refund-disagree').click(function () {
            // laravel-admin 使用的 sweetAlert 版本与我们在前台使用的版本不一样,则参数不一样
            swal({
                title: '输入拒绝理由',
                input: 'text',
                ...
                preConfirm: function (inputValue) {
                    ...
                    // laravel-admin 没有axios, 使用jQuery 的ajax方法来请求
                    return $.ajax({
                        url: '{{ route('admin.orders.handle_refund', [$order->id]) }}',
                        type: 'POST',
                        data: JSON.stringify({ //将请求变成json字符串
                            agree: false, // 拒绝申请
                            reason: inputValue,
                            // 带上 CSRF Token
