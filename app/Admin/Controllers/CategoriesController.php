...
class CategoriesController extends AdminController
{
    ...
    protected function form($isEditing=false)
    {
        ...
        $form->text('name', '类目名称')->required('required');
        if ( $isEditing ) {
            // 不允许修改[是否目录]和父类目字段的值
    ...
    public function apiIndex(Request $request)
    {
        ...
        $result = Category::query()
            ->where('is_directory', boolval($request->input('is_directory', true))) // 由于这里选择的是父类目, 因此需要限定 is_directory 为true
